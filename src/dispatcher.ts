 ...
 * src/dispatcher.ts
 *
 * Exports the core dispatch cycle and layer composition so both the standalone
 * binary (src/index.ts) and the OpenClaw plugin (plugin/service.ts) can use them.
 */
...
export const SpawnerLayer = Effect.gen(function* () {
